...
export default function BusinessVerificationScreen() {
  ...
  const [uploadingKey, setUploadingKey] = useState<"pan" | "address" | null>(
    null,
  );
  ...
  const pickDoc = async (key: "pan" | "address") => {
    ...
    try {
      ...
      const next: StoredDoc = {
        name:
          asset.fileName ??
          (key === "pan" ? "business-pan.jpg" : "shop-license.jpg"),
  ...
  return (
    <Screen testID="screen-business-verify">
      ...
      >
        ...
        >
          <Text
            variant={category ? "body" : "body"}
            tone={category ? "primary" : "tertiary"}
        ...
        <InfoBanner
          ...
          description="Your business name, GSTIN and category save to your real profile. Uploaded documents stay on this device for now (PNG or JPG — PDF isn’t supported yet) and are not sent for review; our team reviews the profile itself, and your current status is shown below."
        />
        ...
        {isVerified === true ? (
          <InfoBanner
            ...
            title="Verified"
            description="Your business profile is already verified."
          />
        ) : (
          <InfoBanner
            tone="warning"
        ...
        {saved ? (
          <InfoBanner
            ...
            title="Details saved"
            description="Your business name, category and GSTIN were saved to your profile."
          />
        ) : null}
      ...
      {!token ? (
        <View style={styles.authNotice}>
          <InfoBanner
            ...
            description="Sign in with a BUSINESS account to save your verification details."
          />
        </View>
      ) : null}
